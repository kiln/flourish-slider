...
Slider.prototype.margin = function Slider_margin(options) {
	...
	for (k$1 in options) {
		if (k$1 in this._margin) this._margin[k$1] = options[k$1];
		else throw "Kiln.slider.margin: unrecognised option " + k$1;
	}
	return this;
};
...
Slider.prototype.draw = function Slider_draw() {
	...
	this.scale = (this._scale ? this._scale() : linear$2()).domain(this._domain).range([0, w]);
...
function test1() {
	var output = d3_select("#test1 .output");
	var slider = Kiln_slider("#test1 .slider").margin({top: 13})
	...
	d3_select("#test1 button.reset").on("click", function() {
		slider.value(0.5).draw();
	});
	d3_select("#test1 button.redraw").on("click", function() {
		slider.draw();
	});
...
function test2() {
	var slider = Kiln_slider("#test2 .slider")
		.domain([2000, 2014])
		.value(2000)
		.snap(true)
...
function test3() {
	var output = d3_select("#test3 .output");
	var slider = Kiln_slider("#test3 .slider")
		.domain([2000, 2014])
		.axis(true)
		.ticks(2)
		.tickFormat(format("d"))
...
function test4() {
	var output = d3_select("#test4 .output");
	var slider = Kiln_slider("#test4 .slider")
		.scale(time)
		.domain([
			new Date(2012, 0, 1),
			new Date(2013, 0, 1)
		])
		.axis(true).ticks(4).tickFormat(time().tickFormat())
		.on("change", function(x) {
...
function test5() {
	var slider = Kiln_slider("#test5 .slider")
		.axis(true)
		.handleFill("red")
...
function test6() {
	var slider = Kiln_slider("#test6 .slider")
		.domain([1900, 2000])
		.axis(true)
		.tickFormat(format("d"))
		.value(1950)
...
function test7() {
	var slider = Kiln_slider("#test7 .slider")
		.domain([1900, 2000])
		.axis(true)
		.tickFormat(format("d"))
		.value(1950)
...
function test8() {
	var slider = Kiln_slider("#test8 .slider")
		.domain([1900, 2000])
...
function test9() {
	var slider = Kiln_slider("#test9 .slider")
		.domain([1900, 2000])
		.margin({top: 20, left: 100, right: 100})
		.tickFormat(format("d"))
		.value(1950)
...
function test10() {
	var slider = Kiln_slider("#test10 .slider")
		.domain([0, 1])
		.tickFormat(format("d"))
		.value(0)
...
function test11() {
	var slider = Kiln_slider("#test11 .slider svg g")
		.width(400).height(50)
		.domain([0, 10])
		.tickFormat(format("d"))
		.value(0)
